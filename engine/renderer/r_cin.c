...
void Huff1TableInit(void)
{
    ...
    for (prev = 0; prev < 256; prev++)
    {
        ...
        memcpy(counts, cin->offset, sizeof(counts));
...
qboolean R_CIN_DrawCinematic(void)
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, gl_tex_solid_format, cin->p2_width, cin->p2_height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
...
void R_CIN_PlayCinematic(char *arg)
{
    ...
    cin->width      = GetInteger(cin->offset);
    cin->offset    += 4;
    cin->height     = GetInteger(cin->offset);
    cin->offset    += 4;
    cin->s_rate     = GetInteger(cin->offset);
    cin->offset    += 4;
    cin->s_width    = GetInteger(cin->offset);
    cin->offset    += 4;
    cin->s_channels = GetInteger(cin->offset);
    cin->offset    += 4;
