...
void SP_misc_actor(edict_t *self)
{
    ...
    if (!VectorLength(self->muzzle))
    {
        ...
        case ACTOR_HUNTER:
            ...
            {
            case  1:
                VectorSet(self->muzzle, 32, 5, 15);
                break;

            case  2:
                VectorSet(self->muzzle, 36, 5, 15);
                break;
            ...
            case  4:
                VectorSet(self->muzzle, 38, 4, 19);
                break;

            case  5:
                VectorSet(self->muzzle, 45, 4.5, 15);
                break;
            ...
            case  7:
                VectorSet(self->muzzle, 40, 5, 15);
                break;

            case  8:
                VectorSet(self->muzzle, 41, 4, 19);
                break;

            case  9:
                VectorSet(self->muzzle, 40, 4, 19);
                break;

            case 10:
                VectorSet(self->muzzle, 42, 5, 20);
                break;
            }
            break;
        ...
        case ACTOR_PARANOID:
            ...
            {
            case  1:
                VectorSet(self->muzzle, 18, 7, 10);
                break;

            case  2:
                VectorSet(self->muzzle, 22, 7, 10);
                break;
            ...
            case  4:
                VectorSet(self->muzzle, 18, 7, 12);
                break;

            case  5:
                VectorSet(self->muzzle, 26, 7, 16);
                break;

            case  6:
                VectorSet(self->muzzle, 24, 7, 10);
                break;

            case  7:
                VectorSet(self->muzzle, 26, 7, 10);
                break;

            case  8:
                VectorSet(self->muzzle, 18, 7, 14);
                break;

            case  9:
                VectorSet(self->muzzle, 28, 7, 10);
                break;
        ...
        case ACTOR_WASTE:
            ...
            {
            case  1:
                VectorSet(self->muzzle, 12, 9, 9);
                break;

            case  2:
                VectorSet(self->muzzle, 22, 9, 9);
                break;

            case  3:
                VectorSet(self->muzzle, 20, 9, 9);
                break;

            case  4:
                VectorSet(self->muzzle, 11, 11, 7);
                break;

            case  5:
                VectorSet(self->muzzle, 26, 8, 8);
                break;

            case  6:
                VectorSet(self->muzzle, 18, 9, 7);
                break;

            case  7:
                VectorSet(self->muzzle, 26, 9, 7);
                break;

            case  8:
                VectorSet(self->muzzle, 26, 7.5, 8);
                break;
        ...
        case ACTOR_ZUMLIN:
            ...
            {
            case  1:
                VectorSet(self->muzzle, 22, 3, 8);
                break;

            case  2:
                VectorSet(self->muzzle, 20, 2, 9);
                break;
            ...
            case  4:
                VectorSet(self->muzzle, 8, 5, 4);
                break;

            case  5:
                VectorSet(self->muzzle, 22, 2, 4);
                break;

            case  6:
                VectorSet(self->muzzle, 20, 2, 7);
                break;

            case  7:
                VectorSet(self->muzzle, 30, 2, 9);
                break;

            case  8:
                VectorSet(self->muzzle, 20, 3, 2);
                break;

            case  9:
                VectorSet(self->muzzle, 26, 2, 9);
                break;

            case 10:
                VectorSet(self->muzzle, 16, 5, -2);
                break;
            }
            break;
        ...
        default:
            ...
            {
            case 4:
                VectorSet(self->muzzle, 6, 9, 6);
                break;

            case 5:
                VectorSet(self->muzzle, 20, 9, 8);
                break;

            case 8:
                VectorSet(self->muzzle, 18, 8, 6);
                break;

            default:
                VectorSet(self->muzzle, 18.4, 7.4, 9.6);
                break;
            }
        }
    }
...
void actor_files()
{
    ...
    for (i = game.maxclients + 1; i < globals.num_edicts; i++)
    {
        ...
        if (!(e->monsterinfo.aiflags & AI_ACTOR))
        {
            continue;
        }
        ...
        for (k = 0; k < 2; k++)
        {
            ...
            {
            case 2:
                strcat(filename, "w_shotgun.md2");
                break;

            case 3:
                strcat(filename, "w_sshotgun.md2");
                break;

            case 4:
                strcat(filename, "w_machinegun.md2");
                break;

            case 5:
                strcat(filename, "w_chaingun.md2");
                break;

            case 6:
                strcat(filename, "w_glauncher.md2");
                break;

            case 7:
                strcat(filename, "w_rlauncher.md2");
                break;

            case 8:
                strcat(filename, "w_hyperblaster.md2");
                break;

            case 9:
                strcat(filename, "w_railgun.md2");
                break;

            case 10:
                strcat(filename, "w_bfg.md2");
                break;

            default:
                strcat(filename, "w_blaster.md2");
                break;
            }
