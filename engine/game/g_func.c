...
void box_water_friction(edict_t *ent)
{
    ...
    if (ent->crane_control)
    {
        return;                                         // currently under control of a crane
    }
...
void pivot_touch(edict_t *ent, edict_t *other, cplane_t *plane, csurface_t *surf)
{
    ...
    if (!other->mass)
    {
        return;                                // other is weightless
    }
    if (!other->groundentity)
    {
        return;                                // other is in air
    }
    if (other->groundentity != ent)
    {
        return;                                // other is not standing on ent
    }
