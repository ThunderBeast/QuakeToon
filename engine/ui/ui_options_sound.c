...
static void SoundSetMenuItemValues(void)
{
    ...
    {
    case 48:
        s_options_sound_quality_list.curvalue = 3;
        break;

    case 44:
        s_options_sound_quality_list.curvalue = 2;
        break;

    case 22:
        s_options_sound_quality_list.curvalue = 1;
        break;

    default:
        s_options_sound_quality_list.curvalue = 0;
        break;
    }
    //** DMP end sound menu changes
