...
// Knightmare changed
void TextureAxisFromPlane(plane_t *pln, vec3_t xv, vec3_t yv, qboolean isTerrain)
{
	int		bestaxis;
	vec_t	dot,best;
	int		i;
	int		numaxis; // Knightmare added

	// Knightmare- terrain support, use floor/ceiling axis only
	//if (isTerrain)	numaxis = 2;
	//else	numaxis = 6;
	...
	for (i=0; i<numaxis; i++) // Knightmare- was 6
	{
