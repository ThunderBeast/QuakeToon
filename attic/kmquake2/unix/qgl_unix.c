...
void ( APIENTRY * gl3DfxSetPaletteEXT)( GLuint * );
...
void ( APIENTRY * glStencilFuncSeparateATI)(GLenum frontfunc, GLenum backfunc, GLint red, GLuint mask);
...
qboolean QGL_Init( const char *dllname )
{
	...
	glGetTexLevelParameterfv    = 	dllGetTexLevelParameterfv    = GPA( "glGetTexLevelParameterfv" );
	glGetTexLevelParameteriv    = 	dllGetTexLevelParameteriv    = GPA( "glGetTexLevelParameteriv" );
...
*/
	glXChooseVisual             =  GPA("glXChooseVisual");
	glXCreateContext            =  GPA("glXCreateContext");
	glXDestroyContext           =  GPA("glXDestroyContext");
	glXMakeCurrent              =  GPA("glXMakeCurrent");
	glXCopyContext              =  GPA("glXCopyContext");
	glXSwapBuffers              =  GPA("glXSwapBuffers");
